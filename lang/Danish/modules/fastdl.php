 ...
 *
 * OGP - Open Game Panel
 * Copyright Copyright (C) 2008 - 2014 The OGP Development Team
 *
...
define('match_file_extension_info', "Specify extensions separated by coma,<br> the matching files will be accessible.<br>".
									"<b>Blank for unrestricted access</b>.");
define('match_client_ip', "Match client IP");
define('match_client_ip_info', "Connections with matching IP will be granted,<br>".
							   "blank for unrestricted access.<br>".
							   "You can use multiple IPs<br>".
							   "or ranges separated by coma:<br>".
							   "/xx subnets<br>".
							   "Example: 10.0.0.0/16<br>".
							   "/xxx.xxx.xxx.xxx subnets<br>".
							   "Example: 10.0.0.0/255.0.0.0<br>".
							   "Hyphen ranges<br>".
							   "Example: 10.0.0.5-230<br>".
...
define('warning_access_rules_applied_once_alias_created', "WARNING: Access rules are applied when the alias is created. ".
														  "No changes will be applied to the current aliases.");
